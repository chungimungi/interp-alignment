...
def explain_no_configs(results_root: Path) -> None:
    ...
    if parsed is None:
        print(
            ...
            "Use --results-root pointing at interp_utils/crosscoder-multilayer/results (parent of run dirs) "
    ...
    if not feat_csv.exists():
        ...
        print(
            ...
            f"  python -m interp_utils.crosscoder-multilayer.main --base-model <BASE_HF_ID> --aligned-model <ALIGNED_HF_OR_PATH> "
